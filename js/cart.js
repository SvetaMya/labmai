...
<article class="cart-content__product cart-product" data-id="${id}">
  <img class="cart-product__img" src="${img}" alt="АЛГ-01П (MAICryoPower)">
  ...
  return `<li class="order-modal__item">
            <article class="order-modal__product order-product" data-id="${id}">
              ...
              <div class="order-product__text">
                ...
                <span class="order-product__price">${normalPrice(
                  price
                )} ₽</span>
              </div>
              <button class="order-product__detele">Удалить</button>
            </article>
          </li>`;
};
